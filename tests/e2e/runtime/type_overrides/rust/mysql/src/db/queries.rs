...
pub async fn insert_event(pool: &DbPool, name: String, payload: serde_json::Value, meta: Option<serde_json::Value>, doc_id: String, created_at: time::PrimitiveDateTime, scheduled_at: Option<time::PrimitiveDateTime>, event_date: Option<time::Date>, event_time: Option<time::Time>) -> Result<(), sqlx::Error> {
    let sql = r##"
...
pub async fn insert_event_rows(pool: &DbPool, name: String, payload: serde_json::Value, meta: Option<serde_json::Value>, doc_id: String, created_at: time::PrimitiveDateTime, scheduled_at: Option<time::PrimitiveDateTime>, event_date: Option<time::Date>, event_time: Option<time::Time>) -> Result<u64, sqlx::Error> {
    let sql = r##"
        INSERT INTO event (name, payload, meta, doc_id, created_at, scheduled_at, event_date, event_time)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    "##;
...
impl<'a> Querier<'a> {
    ...
    pub async fn insert_event(&self, name: String, payload: serde_json::Value, meta: Option<serde_json::Value>, doc_id: String, created_at: time::PrimitiveDateTime, scheduled_at: Option<time::PrimitiveDateTime>, event_date: Option<time::Date>, event_time: Option<time::Time>) -> Result<(), sqlx::Error> {
    ...
    pub async fn insert_event_rows(&self, name: String, payload: serde_json::Value, meta: Option<serde_json::Value>, doc_id: String, created_at: time::PrimitiveDateTime, scheduled_at: Option<time::PrimitiveDateTime>, event_date: Option<time::Date>, event_time: Option<time::Time>) -> Result<u64, sqlx::Error> {
    ...
    pub async fn update_event_date(&self, event_date: Option<time::Date>, id: i64) -> Result<(), sqlx::Error> {
