...
public final class Queries {
    ...
    private static final String SQL_INSERT_RECORD = """
            ...
            VALUES (?, ?, ?);
            """;
    public static void insertRecord(Connection conn, String label, java.util.List<java.time.LocalDateTime> timestamps, java.util.List<java.util.UUID> uuids) throws SQLException {
