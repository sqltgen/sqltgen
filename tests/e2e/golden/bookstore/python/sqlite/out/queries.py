...
def get_books_by_price_range(conn: Connection, price: float, price_2: float) -> list[GetBooksByPriceRangeRow]:
...
def get_book_price_label(conn: Connection, price: float) -> list[GetBookPriceLabelRow]:
...
def get_book_price_or_default(conn: Connection, price: float | None) -> list[GetBookPriceOrDefaultRow]:
...
def get_books_with_recent_sales(conn: Connection, ordered_at: Any) -> list[GetBooksWithRecentSalesRow]:
...
def list_active_products(conn: Connection, active: int) -> list[ListActiveProductsRow]:
...
def get_books_published_between(conn: Connection, published_at: str | None, published_at_2: str | None) -> list[GetBooksPublishedBetweenRow]:
...
def insert_product(conn: Connection, id: str, sku: str, name: str, active: int, weight_kg: float | None, rating: float | None, metadata: str | None, thumbnail: bytes | None, stock_count: int) -> None:
    exec_stmt(conn, SQL_INSERT_PRODUCT, (id, sku, name, active, weight_kg, rating, metadata, thumbnail, stock_count))


def upsert_product(conn: Connection, id: str, sku: str, name: str, active: int, metadata: str | None, stock_count: int) -> None:
...
class Querier:
    ...
    def get_books_by_price_range(self, price: float, price_2: float) -> list[GetBooksByPriceRangeRow]:
        with closing(self._connect()) as conn:
    ...
    def get_book_price_label(self, price: float) -> list[GetBookPriceLabelRow]:
        with closing(self._connect()) as conn:
            return get_book_price_label(conn, price)

    def get_book_price_or_default(self, price: float | None) -> list[GetBookPriceOrDefaultRow]:
        with closing(self._connect()) as conn:
    ...
    def get_books_with_recent_sales(self, ordered_at: Any) -> list[GetBooksWithRecentSalesRow]:
        with closing(self._connect()) as conn:
    ...
    def list_active_products(self, active: int) -> list[ListActiveProductsRow]:
        with closing(self._connect()) as conn:
    ...
    def get_books_published_between(self, published_at: str | None, published_at_2: str | None) -> list[GetBooksPublishedBetweenRow]:
        with closing(self._connect()) as conn:
    ...
    def insert_product(self, id: str, sku: str, name: str, active: int, weight_kg: float | None, rating: float | None, metadata: str | None, thumbnail: bytes | None, stock_count: int) -> None:
        with closing(self._connect()) as conn:
            return insert_product(conn, id, sku, name, active, weight_kg, rating, metadata, thumbnail, stock_count)

    def upsert_product(self, id: str, sku: str, name: str, active: int, metadata: str | None, stock_count: int) -> None:
        with closing(self._connect()) as conn:
            return upsert_product(conn, id, sku, name, active, metadata, stock_count)
