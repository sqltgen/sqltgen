...
pub async fn create_author<'e, E>(executor: E, name: String, bio: Option<String>, birth_year: Option<i32>) -> Result<(), sqlx::Error>
where
...
pub async fn get_author<'e, E>(executor: E, id: i32) -> Result<Option<Author>, sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn create_book<'e, E>(executor: E, author_id: i32, title: String, genre: String, price: f64, published_at: Option<String>) -> Result<(), sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn get_book<'e, E>(executor: E, id: i32) -> Result<Option<Book>, sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn create_customer<'e, E>(executor: E, name: String, email: String) -> Result<(), sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn create_sale<'e, E>(executor: E, customer_id: i32) -> Result<(), sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn add_sale_item<'e, E>(executor: E, sale_id: i32, book_id: i32, quantity: i32, unit_price: f64) -> Result<(), sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn get_books_by_price_range<'e, E>(executor: E, price: f64, price_2: f64) -> Result<Vec<GetBooksByPriceRangeRow>, sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn get_book_price_label<'e, E>(executor: E, price: f64) -> Result<Vec<GetBookPriceLabelRow>, sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn get_book_price_or_default<'e, E>(executor: E, price: Option<f64>) -> Result<Vec<GetBookPriceOrDefaultRow>, sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn delete_book_by_id<'e, E>(executor: E, id: i32) -> Result<u64, sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn get_product<'e, E>(executor: E, id: String) -> Result<Option<Product>, sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn list_active_products<'e, E>(executor: E, active: i32) -> Result<Vec<ListActiveProductsRow>, sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn get_books_published_between<'e, E>(executor: E, published_at: Option<String>, published_at_2: Option<String>) -> Result<Vec<GetBooksPublishedBetweenRow>, sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn count_sale_items<'e, E>(executor: E, sale_id: i32) -> Result<Option<CountSaleItemsRow>, sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn update_author_bio<'e, E>(executor: E, bio: Option<String>, id: i32) -> Result<(), sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn delete_author<'e, E>(executor: E, id: i32) -> Result<(), sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn insert_product<'e, E>(executor: E, id: String, sku: String, name: String, active: i32, weight_kg: Option<f32>, rating: Option<f32>, metadata: Option<String>, thumbnail: Option<Vec<u8>>, stock_count: i32) -> Result<(), sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
...
pub async fn upsert_product<'e, E>(executor: E, id: String, sku: String, name: String, active: i32, metadata: Option<String>, stock_count: i32) -> Result<(), sqlx::Error>
where
    E: sqlx::Executor<'e, Database = sqlx::Sqlite>,
{
    let sql = r##"
