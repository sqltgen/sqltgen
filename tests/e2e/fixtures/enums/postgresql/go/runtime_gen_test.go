...
func TestCreateAndGetTaskGen(t *testing.T) {
	...
	if task.Priority != gen.Priority(gen.Priority("high")) { t.Errorf("expected %v, got %v", gen.Priority(gen.Priority("high")), task.Priority) }
	if task.Status != gen.Status(gen.Status("open")) { t.Errorf("expected %v, got %v", gen.Status(gen.Status("open")), task.Status) }
...
func TestUpdateTaskStatusGen(t *testing.T) {
	...
	if updated.Status != gen.Status(gen.Status("in_progress")) { t.Errorf("expected %v, got %v", gen.Status(gen.Status("in_progress")), updated.Status) }
	if updated.Priority != gen.Priority(gen.Priority("critical")) { t.Errorf("expected %v, got %v", gen.Priority(gen.Priority("critical")), updated.Priority) }
}
...
func TestCreateWithEnumArrayGen(t *testing.T) {
	...
	if task.Tags[0] != gen.Priority(gen.Priority("high")) { t.Errorf("expected %v, got %v", gen.Priority(gen.Priority("high")), task.Tags[0]) }
	if task.Tags[1] != gen.Priority(gen.Priority("critical")) { t.Errorf("expected %v, got %v", gen.Priority(gen.Priority("critical")), task.Tags[1]) }
}
...
func TestGetTaskTagsGen(t *testing.T) {
	...
	if row.Tags[0] != gen.Priority(gen.Priority("low")) { t.Errorf("expected %v, got %v", gen.Priority(gen.Priority("low")), row.Tags[0]) }
	if row.Tags[1] != gen.Priority(gen.Priority("medium")) { t.Errorf("expected %v, got %v", gen.Priority(gen.Priority("medium")), row.Tags[1]) }
	if row.Tags[2] != gen.Priority(gen.Priority("high")) { t.Errorf("expected %v, got %v", gen.Priority(gen.Priority("high")), row.Tags[2]) }
}
...
func TestUpdateTaskTagsGen(t *testing.T) {
	...
	if updated.Tags[0] != gen.Priority(gen.Priority("high")) { t.Errorf("expected %v, got %v", gen.Priority(gen.Priority("high")), updated.Tags[0]) }
	if updated.Tags[1] != gen.Priority(gen.Priority("critical")) { t.Errorf("expected %v, got %v", gen.Priority(gen.Priority("critical")), updated.Tags[1]) }
}
