...
async function seed(db: mysql.Connection): Promise<void> {
...
async function query(db: mysql.Connection): Promise<void> {
...
async function run(dbName: string): Promise<void> {
