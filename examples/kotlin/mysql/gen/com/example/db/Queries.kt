...
object Queries {
    ...
    private const val SQL_GET_BOOKS_BY_IDS = "SELECT id, author_id, title, genre, price, published_at FROM book WHERE id IN (SELECT value FROM JSON_TABLE(?,'$[*]' COLUMNS(value BIGINT PATH '$')) t) ORDER BY title;"
