...
pub fn sql_type_key(sql_type: &SqlType) -> &'static str {
    match sql_type {
        ...
        SqlType::TinyIntUnsigned => "tinyint_unsigned",
        SqlType::SmallIntUnsigned => "smallint_unsigned",
        SqlType::IntegerUnsigned => "integer_unsigned",
        SqlType::BigIntUnsigned => "bigint_unsigned",
        SqlType::Real => "real",
